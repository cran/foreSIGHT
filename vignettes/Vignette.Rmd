...
plotArgs<-list(title="Roof area 100 m2",performancelimits=c(0.705, 0.78),ylim=c(0.8,1.201))
...
plotArgs<-list(title="Roof area 110 m2",performancelimits=c(0.705, 0.78),ylim=c(0.8,1.201))
...
#Plot arguments
plotArgs<-list(title="Roof area 100 m2",performancelimits=c(0.705, 0.78),ylim=c(0.8,1.20))
...
```{r  testclim,fig.align='center',dpi=100, fig.width=7,fig.height=7,warning=FALSE,message=FALSE}
data(tankPlot)
...
```{r  testclim2,fig.align='center',dpi=100, fig.width=7,fig.height=7,warning=FALSE,message=FALSE}
...
- McPhail, C., Maier, H. R., Kwakkel, J. H., Giuliani, M., Castelletti, A. and Westra, S. (2018), Robustness Metrics: How Are They Calculated, When Should They Be Used and Why Do They Give Different Results?. *Earth's Future.* [doi:10.1002/2017EF000649](http://dx.doi.org/10.1002/2017EF000649).
...
- Richardson, C. W. (1981), Stochastic simulation of daily precipitation, temperature, and solar radiation, *Water Resour. Res.*, 17(1), 182-190, [doi:10.1029/WR017i001p00182](http://dx.doi.org/10.1029/WR017i001p00182).
